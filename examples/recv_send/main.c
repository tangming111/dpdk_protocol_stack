...
static struct rte_mbuf *ng_send(struct rte_mempool *mempool, uint8_t *data, uint16_t length) {
...
#if ENABLE_SEND
                struct rte_mbuf *tx_mbuf = ng_send(mbuf_pool, (uint8_t *)(udp_hdr + 1), legth);
